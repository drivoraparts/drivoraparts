...
export const productLogistics: Record<number, ProductLogistics> = {
  ...
  ===================================================== */
  3: {
    fitment: "Fits Toyota Camry, Corolla & RAV4 platforms. OEM-spec output.",
    included: ["Alternator assembly", "OEM pulley & connector"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  4: {
    fitment: "Fits Toyota platforms — confirm application at checkout.",
    included: ["Starter motor assembly", "New solenoid contacts"],
    coreCharge: CORE_REQUIRED,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  5: {
    fitment: "Fits Honda platforms — pulled from a verified low-mile donor.",
    included: ["Alternator assembly", "OEM pulley & connector"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  ...
  6: {
    fitment: "Fits Honda K-series and R18 platforms.",
    included: ["Starter motor assembly", "New drive gear"],
    coreCharge: CORE_REQUIRED,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  7: {
    fitment: "Fits BMW N55 applications (F30/F32). Load-tested to OEM spec.",
    included: ["Alternator assembly", "OEM pulley & connector"],
    coreCharge: CORE_REQUIRED,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  ...
  8: {
    fitment: "Fits BMW N52-powered E90. Pulled and verified before listing.",
    included: ["Starter motor assembly"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  9: {
    fitment:
      "Fits Mercedes-Benz M276-powered W204/W212 chassis. OEM connector and pulley.",
    included: ["Alternator assembly", "OEM pulley & connector"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  ...
  10: {
    partNumber: "OM642 VGT Turbo",
    fitment:
      "Fits Mercedes-Benz OM642 3.0L diesel applications. New actuator, balanced CHRA.",
    included: ["Turbocharger / CHRA assembly", "New actuator", "Gaskets"],
    coreCharge: CORE_REQUIRED,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  11: {
    fitment: "Fits Audi B8 platform. Clear lenses, no moisture intrusion.",
    included: ["Left & right LED headlight assemblies"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  12: {
    fitment: "Fits Audi B8 A4 sedan (inner & outer housings).",
    included: ["Inner & outer tail light housings"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  13: {
    fitment: "Fits Ford Mustang GT (S550). New seals and pistons.",
    included: ["Front brake caliper", "New seals & piston(s)"],
    coreCharge: CORE_REQUIRED,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  14: {
    fitment: "Fits Ford F-150 (2018). No leaks, smooth rebound.",
    included: ["Front strut assembly"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  15: {
    fitment:
      "Fits GMT K2XX Chevrolet Silverado / GMC Sierra. Direct-fit OEM replacement.",
    included: ["Aluminum radiator", "Mounting hardware"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  16: {
    partNumber: "GM LS3 ECM",
    fitment:
      "Fits Chevrolet LS3 applications. Flashed and communication-tested; VIN-relink may be required.",
    included: ["Engine control module"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  17: {
    fitment: "Fits Nissan 350Z (VQ35DE). Charging output verified.",
    included: ["Alternator assembly"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  18: {
    fitment:
      "Fits Nissan R35 GT-R. Balanced turbine wheel; sold as a single cartridge.",
    included: ["Turbo cartridge / CHRA assembly", "Gaskets"],
    coreCharge: CORE_REQUIRED,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  19: {
    fitment: "Fits Lexus IS250 (RH front). No cracks or sun fade.",
    included: ["Passenger-front door panel"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  20: {
    fitment:
      "Fits Lexus RX350. Power-folding with working turn signal and heat.",
    included: ["Power-folding side mirror assembly"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  21: {
    fitment: "Fits Jeep Wrangler JK/JL 3.6L. Includes heat shield and filter.",
    included: ["Intake tube", "Air filter", "Heat shield & hardware"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  22: {
    fitment: "Fits Jeep Grand Cherokee WK2 (rear). Piston moves freely.",
    included: ["Rear brake caliper"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  23: {
    fitment: "Fits third-gen Toyota Tacoma. Upgraded DRL board.",
    included: ["Left & right LED headlight assemblies"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  ...
  24: {
    fitment: "Fits Honda Accord 2.4L (2016). Pressure tested, no core damage.",
    included: ["Radiator"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  ...
  25: {
    fitment: "Fits BMW F30 (front lower). New bushings and ball joint.",
    included: ["Front lower control arm", "Bushings & ball joint"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  26: {
    fitment: "Fits Mercedes-Benz C250 W204. Spin test passed.",
    included: ["Starter motor assembly"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  ...
  27: {
    fitment:
      "Fits Audi Q5 8R (driver side). Includes blind-spot indicator.",
    included: ["Driver-side power mirror assembly"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  28: {
    partNumber: "2.3L EcoBoost Turbo",
    fitment:
      "Fits Ford 2.3L EcoBoost (Mustang & Focus RS platforms).",
    included: ["Turbocharger assembly", "Gaskets"],
    coreCharge: CORE_REQUIRED,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  29: {
    fitment: "Fits fifth-gen Chevrolet Camaro. Lenses clear, no broken tabs.",
    included: ["Left & right tail light assemblies"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  30: {
    partNumber: "Nissan QR25DE ECU",
    fitment:
      "Fits Nissan Altima (QR25DE). VIN-matched programming available on request.",
    included: ["Engine control unit"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  31: {
    fitment:
      "Fits Lexus GS350 3.5L V6. Reusable filter and velocity stack.",
    included: ["Intake system", "Reusable air filter", "Hardware"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
  32: {
    fitment: "Fits Jeep Cherokee KL (LH rear). Minor scuff, structurally sound.",
    included: ["Rear-left door panel assembly"],
    coreCharge: OUTRIGHT,
    freightNotes: PARCEL_FREIGHT,
    warrantyTerms: PARTS_ONLY,
  },
