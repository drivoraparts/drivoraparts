...
export default function CategoryGrid() {
  const tileClass =
    "group relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-5 transition-all duration-300 active:scale-95 hover:border-accent hover:bg-accent-subtle hover:shadow-md";
