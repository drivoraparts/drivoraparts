...
/** Shared spinner used anywhere a status reads as "yellow" -- amber/pending
 * badges, the shipment-hold indicator, etc. -- so every in-progress
 * indicator in the app spins consistently instead of sitting static. */
export function SpinnerIcon({ className = "h-2.5 w-2.5" }: { className?: string }) {
  return (
