 ...
 * Each dark editorial panel is followed immediately by the actual catalogue
 ...
 *
 * The alternation is the point. A dark, graded, near-monochrome panel drops
 * into a bright full-colour product rail and back again, which is what stops
 * the page reading as one long grey scroll. The photography carries the mood;
 * the products stay clean and commercial.
 */
...
export default function BuildStorySection() {
  return (
    <>
      <section
        className="bg-background-dark pt-20 pb-16 sm:pt-28 sm:pb-20"
      ...
      {STORIES.map((story, i) => {
        ...
        return (
          <div key={story.slot}>
            <section className="bg-background-dark pb-16 sm:pb-20">
