...
const EDITORIAL = [
  ...
  },
  {
    ...
    pq: [
      "pickup truck dusty road afternoon sunlight",
      "farm pickup truck loaded golden hour",
      "truck towing trailer dirt road sunlight",
      "pickup truck working rural dust sunlight",
    ],
  ...
  },
  {
    ...
    pq: [
      "off road vehicle dust backlit golden sunlight",
      "4x4 driving desert sand sunlight dramatic shadows",
      "jeep rock trail warm sunlight dust",
      "off road truck dust cloud sunset backlit",
    ],
