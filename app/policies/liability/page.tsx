    ...
    <Policy
      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            "To the maximum extent permitted by law, BROOKSTONEUS LLC, together with its officers, employees, agents, and partners, shall not be liable for any damages arising out of or in connection with your use of, or inability to use, the Services or any products purchased through them.",
          ],
        },
        {
          heading: "No Responsibility for Indirect Damages",
          paragraphs: [
            "In no event shall BROOKSTONEUS LLC be liable for any indirect, incidental, special, consequential, exemplary, or punitive damages, including loss of profits, revenue, data, goodwill, or other intangible losses, even if we have been advised of the possibility of such damages.",
          ],
        },
        {
          heading: "Maximum Liability Cap",
          paragraphs: [
            "Where liability cannot be fully excluded, the total aggregate liability of BROOKSTONEUS LLC for any claim arising out of or relating to the Services or a product shall not exceed the total amount you actually paid for the specific product or order giving rise to the claim.",
          ],
        },
        {
          heading: "Product Use and Installation",
          paragraphs: [
            "BROOKSTONEUS LLC is not responsible or liable for any damage, injury, or loss resulting from the improper installation, misuse, modification, or use of products contrary to manufacturer guidance, professional recommendations, or applicable law. You assume all risk associated with the installation and use of products.",
          ],
        },
        {
          heading: "Shipping Carrier Liability Disclaimer",
          paragraphs: [
            "Once products are handed over to a shipping carrier, delivery is subject to the carrier's terms, handling, and responsibility. BROOKSTONEUS LLC is not liable for the acts or omissions of carriers, including delays, mishandling, loss, or damage occurring while a package is in the carrier's possession, except as required by law.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            "BROOKSTONEUS LLC shall not be liable for any failure or delay in performance resulting from events beyond our reasonable control, including natural disasters, fire, flood, pandemics, carrier or supplier disruptions, labor disputes, utility or network failures, or governmental actions.",
          ],
        },
        {
